# Contributing to Drabkirn Website
...
3. Set the upstream remote so you can keep your copy of the app synced with the original. To do that, go to your terminal and cd into your cloned Drabkirn Website app directory. Then use one of the following commands:
...
5. When you have finished and are ready to submit a Pull Request:
    * Push your branch to your fork
      ...
      ```
    * Go to your fork on Github after you have pushed up your branch. A new button should be visible near the top of the page. It will allow you to create a pull request to the original Drabkirn Website repo.
